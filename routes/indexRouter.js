...
//post
indexRouter.post('/Category',control.createCategoryValidation,control.addCategory);
...
indexRouter.post('/update-ctgry',control.editCategoryValidation,control.updateCategory);
